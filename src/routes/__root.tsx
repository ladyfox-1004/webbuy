...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Lovable App" },
      { name: "description", content: "My PortOne Hub is a web application for managing and displaying your created websites and integrating PortOne payment processing." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Lovable App" },
      { property: "og:description", content: "My PortOne Hub is a web application for managing and displaying your created websites and integrating PortOne payment processing." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Lovable" },
      { name: "twitter:title", content: "Lovable App" },
      { name: "twitter:description", content: "My PortOne Hub is a web application for managing and displaying your created websites and integrating PortOne payment processing." },
