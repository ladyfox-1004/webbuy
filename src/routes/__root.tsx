...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "에이아이솔루션(AISOLITION)" },
      { name: "description", content: "에이아이솔루션(AISOLITION)은 웹/앱 개발자가 직접 만든 사이트와 앱을 한자리에서 전시하고 결제까지 연결하는 마켓플레이스입니다." },
      { name: "author", content: "AISOLITION" },
      { property: "og:title", content: "에이아이솔루션(AISOLITION)" },
      { property: "og:description", content: "에이아이솔루션(AISOLITION)은 웹/앱 개발자가 직접 만든 사이트와 앱을 한자리에서 전시하고 결제까지 연결하는 마켓플레이스입니다." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@AISOLITION" },
      { name: "twitter:title", content: "에이아이솔루션(AISOLITION)" },
      { name: "twitter:description", content: "에이아이솔루션(AISOLITION)은 웹/앱 개발자가 직접 만든 사이트와 앱을 한자리에서 전시하고 결제까지 연결하는 마켓플레이스입니다." },
